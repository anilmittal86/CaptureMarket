...
METRICS = {
    ...
    "pb": Metric("pb", "P/B", "P/B", "{:.1f}x"),
    "eps_g_1y": Metric("eps_g_1y", "EPS Growth 1Y (%)", "EPS Growth 1Y", "{:+.1f}%"),
    "eps_g_3y": Metric("eps_g_3y", "EPS Growth 3Y (%)", "EPS Growth 3Y", "{:+.1f}%"),
    "profit_g_1y": Metric("profit_g_1y", "Profit Growth 1Y (%)", "Profit Growth 1Y", "{:+.1f}%"),
    "profit_g_3y": Metric("profit_g_3y", "Profit Growth 3Y (%)", "Profit Growth 3Y", "{:+.1f}%"),
...
TOOLTIP_FIELDS = [
    ...
    ("P/B", "P/B", METRICS["pb"].fmt),
    ("EPS Growth 1Y", "EPS Growth 1Y (%)", METRICS["eps_g_1y"].fmt),
    ("EPS Growth 3Y", "EPS Growth 3Y (%)", METRICS["eps_g_3y"].fmt),
    ("Profit Growth 1Y", "Profit Growth 1Y (%)", METRICS["profit_g_1y"].fmt),
    ("Profit Growth 3Y", "Profit Growth 3Y (%)", METRICS["profit_g_3y"].fmt),
